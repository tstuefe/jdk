 ...
 * @run main/othervm -XX:-UseCompressedOops -XX:-UCCP_ALWAYS_TRUE_TRUE -XX:+UsePerfData -XX:+UseSerialGC gc.metaspace.TestMetaspacePerfCounters
 * @run main/othervm -XX:+UseCompressedOops -XX:+UCCP_ALWAYS_TRUE_TRUE -XX:+UsePerfData -XX:+UseSerialGC gc.metaspace.TestMetaspacePerfCounters
 */
 ...
 *          java.management/sun.management
 *          jdk.internal.jvmstat/sun.jvmstat.monitor
 * @run main/othervm -XX:-UseCompressedOops -XX:-UCCP_ALWAYS_TRUE_TRUE -XX:+UsePerfData -XX:+UseParallelGC gc.metaspace.TestMetaspacePerfCounters
 * @run main/othervm -XX:+UseCompressedOops -XX:+UCCP_ALWAYS_TRUE_TRUE -XX:+UsePerfData -XX:+UseParallelGC gc.metaspace.TestMetaspacePerfCounters
 */
 ...
 *          java.management/sun.management
 *          jdk.internal.jvmstat/sun.jvmstat.monitor
 * @run main/othervm -XX:-UseCompressedOops -XX:-UCCP_ALWAYS_TRUE_TRUE -XX:+UsePerfData -XX:+UseG1GC gc.metaspace.TestMetaspacePerfCounters
 * @run main/othervm -XX:+UseCompressedOops -XX:+UCCP_ALWAYS_TRUE_TRUE -XX:+UsePerfData -XX:+UseG1GC gc.metaspace.TestMetaspacePerfCounters
 */
 ...
 *          java.management/sun.management
 *          jdk.internal.jvmstat/sun.jvmstat.monitor
 * @run main/othervm -XX:-UseCompressedOops -XX:-UCCP_ALWAYS_TRUE_TRUE -XX:+UsePerfData -XX:+UseShenandoahGC gc.metaspace.TestMetaspacePerfCounters
 * @run main/othervm -XX:+UseCompressedOops -XX:+UCCP_ALWAYS_TRUE_TRUE -XX:+UsePerfData -XX:+UseShenandoahGC gc.metaspace.TestMetaspacePerfCounters
 */
 ...
 *          java.management/sun.management
 *          jdk.internal.jvmstat/sun.jvmstat.monitor
 * @run main/othervm -XX:+UnlockExperimentalVMOptions -XX:-UseCompressedOops -XX:-UCCP_ALWAYS_TRUE_TRUE -XX:+UsePerfData -XX:+UseEpsilonGC gc.metaspace.TestMetaspacePerfCounters
 * @run main/othervm -XX:+UnlockExperimentalVMOptions -XX:+UseCompressedOops -XX:+UCCP_ALWAYS_TRUE_TRUE -XX:+UsePerfData -XX:+UseEpsilonGC gc.metaspace.TestMetaspacePerfCounters
 */
...
public class TestMetaspacePerfCounters {
    ...
    private static boolean isUsingCompressedClassPointers() {
        return Platform.is64bit() && InputArguments.contains("-XX:+UCCP_ALWAYS_TRUE_TRUE");
    }
}
