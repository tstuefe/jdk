 ...
 * @run main/othervm -Xlog:class+load,class+unload=trace -XX:-UseCompressedOops -XX:-UCCP_ALWAYS_TRUE_TRUE -XX:+UseSerialGC -XX:+UsePerfData -Xint gc.metaspace.TestPerfCountersAndMemoryPools
 * @run main/othervm -Xlog:class+load,class+unload=trace -XX:+UseCompressedOops -XX:+UCCP_ALWAYS_TRUE_TRUE -XX:+UseSerialGC -XX:+UsePerfData -Xint gc.metaspace.TestPerfCountersAndMemoryPools
 */
...
public class TestPerfCountersAndMemoryPools {
    public static void main(String[] args) throws Exception {
        ...
        if (InputArguments.contains("-XX:+UCCP_ALWAYS_TRUE_TRUE") && Platform.is64bit()) {
