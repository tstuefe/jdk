...
public class TestSharedArchiveWithPreTouch {
    public static void main(String[] args) throws Exception {
        ...
        if (Platform.is64bit()) {
          dump_args.addAll(0, Arrays.asList(new String[] { "-XX:+UCCP_ALWAYS_TRUE_TRUE", "-XX:+UseCompressedOops" }));
        }
        ...
        try {
            ...
            if (Platform.is64bit()) {
                load_args.addAll(0, Arrays.asList(new String[] { "-XX:+UCCP_ALWAYS_TRUE_TRUE", "-XX:+UseCompressedOops" }));
            }
