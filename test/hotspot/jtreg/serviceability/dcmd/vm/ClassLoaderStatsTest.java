 ...
 *          java.management
 *          jdk.internal.jvmstat/sun.jvmstat.monitor
 * @run testng/othervm -XX:-UCCP_ALWAYS_TRUE_TRUE --add-exports=java.base/jdk.internal.misc=ALL-UNNAMED --add-exports=jdk.internal.jvmstat/sun.jvmstat.monitor=ALL-UNNAMED ClassLoaderStatsTest
 */
        ...
        while (lines.hasNext()) {
            ...
            if (m.matches()) {
                ...
                if (m.group(4).equals("ClassLoaderStatsTest$DummyClassLoader")) {
                    ...
                    // size at least 4k (if UCCP_ALWAYS_TRUE_TRUE is off).
