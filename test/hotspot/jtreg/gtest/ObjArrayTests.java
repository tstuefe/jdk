 ...
 *          java.xml
 * @run main/native GTestWrapper --gtest_filter=objArrayOop -XX:+UCCP_ALWAYS_TRUE_TRUE -XX:+UseCompressedOops
 */
 ...
 * @modules java.base/jdk.internal.misc
 *          java.xml
 * @run main/native GTestWrapper --gtest_filter=objArrayOop -XX:+UCCP_ALWAYS_TRUE_TRUE -XX:+UseCompressedOops -XX:ObjAlignmentInBytes=256
 */
