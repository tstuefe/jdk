 ...
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:+TieredCompilation -XX:TieredStopAtLevel=1 -Xcomp -XX:-UCCP_ALWAYS_TRUE_TRUE -XX:CompileOnly=TestArrayCopyToFromObject::test TestArrayCopyToFromObject
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:+TieredCompilation -XX:TieredStopAtLevel=1 -Xcomp -XX:+UCCP_ALWAYS_TRUE_TRUE -XX:CompileOnly=TestArrayCopyToFromObject::test TestArrayCopyToFromObject
 */
