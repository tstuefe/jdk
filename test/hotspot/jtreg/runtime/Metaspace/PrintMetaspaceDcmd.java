 ...
 *          java.management
 * @run main/othervm -Dwith-compressed-class-space -XX:MaxMetaspaceSize=201M -Xmx100M -XX:+UseCompressedOops -XX:+UCCP_ALWAYS_TRUE_TRUE PrintMetaspaceDcmd
 */
 ...
 * @modules java.base/jdk.internal.misc
 *          java.management
 * @run main/othervm -Dwithout-compressed-class-space -XX:MaxMetaspaceSize=201M -Xmx100M -XX:-UseCompressedOops -XX:-UCCP_ALWAYS_TRUE_TRUE PrintMetaspaceDcmd
 */
 ...
 * @modules java.base/jdk.internal.misc
 *          java.management
 * @run main/othervm -Dno-specified-flag -Xmx100M -XX:-UseCompressedOops -XX:-UCCP_ALWAYS_TRUE_TRUE PrintMetaspaceDcmd
 */
