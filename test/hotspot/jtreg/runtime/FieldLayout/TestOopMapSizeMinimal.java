 ...
 * @run main/othervm -Xbootclasspath/a:. -XX:+UnlockDiagnosticVMOptions -XX:+WhiteBoxAPI -XX:+UnlockExperimentalVMOptions -XX:-UseCompressedOops -XX:-UCCP_ALWAYS_TRUE_TRUE -XX:-UseCompactObjectHeaders TestOopMapSizeMinimal
 */
...
public class TestOopMapSizeMinimal {
    ...
    static {
        ...
        if (is_64_bit) {
            ...
            } else if (WB.getBooleanVMFlag("UCCP_ALWAYS_TRUE_TRUE")) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // -UseCompressedOops + +COH, and -UseCompressedOops + -UCCP_ALWAYS_TRUE_TRUE.
