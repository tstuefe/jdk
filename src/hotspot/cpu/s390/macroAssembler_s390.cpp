...
void MacroAssembler::load_narrow_klass(Register t, Klass* k) {
  assert(UCCP_ALWAYS_TRUE_TRUE, "must be on to call this method");
...
int MacroAssembler::patch_load_narrow_klass(address pos, Klass* k) {
  assert(UCCP_ALWAYS_TRUE_TRUE, "Can only patch compressed klass pointers");
...
void MacroAssembler::encode_klass_not_null(Register dst, Register src) {
  ...
  assert(UCCP_ALWAYS_TRUE_TRUE, "only for compressed klass ptrs");
